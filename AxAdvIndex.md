...
**Datum, map**
:  [Projection and Scaling](DocBasicsMapDem#projection-and-scaling "Projection and Scaling") ⊞ [Projection and datum](AdvMapDetails#projection-and-datum "Projection and datum")
...
**GPX, save as**
:  [Save GPX Files](DocHandleGpxFiles#save-gpx-files "Save GPX Files")
...
:  [Vector Maps](DocControlMapDem#vector-maps "Vector Maps")
...
:  [Create a Template](DocGisTemplates#create-a-template "Create a Template")
...
**Workspace, data view**
:  [Data view](DocHandleGpxFiles#data-view "Data view")
