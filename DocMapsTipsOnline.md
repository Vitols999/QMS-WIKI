...
|---------|---------|---------|
|World   |[various in package 1](#markdown-header-sources-of-wmts-and-tms-map-files)| Strava heatmaps, maps based on OpenStreetmap |
|Europe  |[various in package 1](#markdown-header-sources-of-wmts-and-tms-map-files)|  maps based on OpenStreetmap|
|Austria |[various in package 1](#markdown-header-sources-of-wmts-and-tms-map-files)|  maps based on OpenStreetmap and other Austrian servers|
...
|Czech Republic|[MTBMap.cz in package 1](#markdown-header-sources-of-wmts-and-tms-map-files)| mountain bike |
|France  |[IGN](#markdown-header-wmts-configuration-for-french-ign-maps), [BRGM](#markdown-header-use-wms-server-as-tms-server)| IGN, geological service |
|Germany |[various in package 1](#markdown-header-sources-of-wmts-and-tms-map-files), [North Rhine-Westphalia](#markdown-header-use-wms-server-as-tms-server) | maps based on OpenStreetmap and some German servers |
|Italy   |[Italy](#markdown-header-use-arcgis-server-as-tms-server)| topo map|
|Norway  |[Norway](#markdown-header-tms-configuration-for-norwegian-topo-maps)| topo map|
|Spain   |[various in package 2](#markdown-header-sources-of-wmts-and-tms-map-files), [IGN](#markdown-header-use-wmts-server-as-tms-server) [Spain orthophotos](#markdown-header-tms-for-spanish-orthophoto-maps)| various Spanish servers |
...
If your request is denied by IGN, it's maybe because QMapShack don't send the right headers, you can specify them manually with the `<RawHeader>` XML node, compare section ["Basic knowledge about maps and DEM files"](DocBasicsMapDem#markdown-header-wmts-maps).
