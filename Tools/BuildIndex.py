...
# W.Thämelt, 17.02.2020: add creation of QMapTool Index
...
cfg["QMT"] = {
# names of index files
"indexfile": r"../QMapTool/QMTAxAdvIndex.md",
"rawindexfile": r"QMTAxData4Index.txt",
}
...
for pkg in cfg.keys():
    indexfile = cfg[pkg]["indexfile"]
    rawindexfile = cfg[pkg]["rawindexfile"]
